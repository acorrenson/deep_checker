...
Nous construisons le réseau grâce aux outils fournis par le module python [scikit-learn](https://scikit-learn.org). L'apprentissage est lancé pour une durée de 500 cycles sur l'ensemble des données $\mathcal{DB}$ étiquetées grâce à la fonction partielle $h$.
